...
namespace Assistant
{
	...
	public class HotKey
	{
		...
		{
            m_ToggleHotKeysHandler = Add( HKCategory.None, LocString.ToggleHKEnable, new HotKeyCallback( OnToggleEnable ) );
		}
		...
		public static bool OnKeyDown( int key )
		{
            ...
            if (m_ToggleHotKeysHandler != null)
            {
                if (m_ToggleHotKeysHandler.Mod == cur && m_ToggleHotKeysHandler.Key == key)
                {
                    m_ToggleHotKeysHandler.Callback();
                    return m_ToggleHotKeysHandler.SendToUO;
                }
            }
