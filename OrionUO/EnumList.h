...
enum CLIENT_VERSION
{
    CV_OLD = CLIENT_VERSION_NUM(1, 0, 0, 0),
    CV_200 = CLIENT_VERSION_NUM(2, 0, 0, 0),
    CV_204C = CLIENT_VERSION_NUM(2, 0, 4, 2),
    CV_305D = CLIENT_VERSION_NUM(3, 0, 5, 3),
    CV_306E = CLIENT_VERSION_NUM(3, 0, 6, 4),
    CV_308D = CLIENT_VERSION_NUM(3, 0, 8, 3),
    CV_308J = CLIENT_VERSION_NUM(3, 0, 8, 9),
    CV_308Z = CLIENT_VERSION_NUM(3, 0, 8, 25),
    CV_400B = CLIENT_VERSION_NUM(4, 0, 0, 1),
    CV_405A = CLIENT_VERSION_NUM(4, 0, 5, 0),
    CV_4011D = CLIENT_VERSION_NUM(4, 0, 11, 3),
    CV_500A = CLIENT_VERSION_NUM(5, 0, 0, 0),
    CV_5020 = CLIENT_VERSION_NUM(5, 0, 2, 0),
    CV_5090 = CLIENT_VERSION_NUM(5, 0, 9, 0),
    CV_6000 = CLIENT_VERSION_NUM(6, 0, 0, 0),
    CV_6013 = CLIENT_VERSION_NUM(6, 0, 1, 3),
    CV_6017 = CLIENT_VERSION_NUM(6, 0, 1, 7),
    CV_6040 = CLIENT_VERSION_NUM(6, 0, 4, 0),
    CV_6060 = CLIENT_VERSION_NUM(6, 0, 6, 0),
    CV_60142 = CLIENT_VERSION_NUM(6, 0, 14, 2),
    CV_60144 = CLIENT_VERSION_NUM(6, 0, 14, 4),
    ...
    CV_70240 = CLIENT_VERSION_NUM(7, 0, 24, 0),
