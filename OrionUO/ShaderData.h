...
static const char *g_Frag_ColorizerShaderData =
    ...
    "				vec3 n2 = normalize(n);\r\n"
    "				vec3 l2 = normalize(l);\r\n"
    "				vec4 normal = vec4(max(dot(n2, l2), 0.0f));\r\n"
    "               float intensity = gl_LightSource[0].ambient.x;\r\n"
    "				if (drawMode > 6)\r\n"
    "				{\r\n"
    "					int index = int(textureColor.r * 31.875) * 3;\r\n"
    ...
    "				}\r\n"
    "				else\r\n"
    "					gl_FragColor = ((textureColor * gl_Color) * normal * intensity) + ((textureColor * gl_Color) * (1.0 - intensity));\r\n"
    "			}\r\n"
    "		}\r\n"
    "		else\r\n"
    "			gl_FragColor = textureColor * gl_Color;\r\n"
