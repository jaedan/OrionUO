...
private:
    ...
    typedef HRESULT(__stdcall *DRAWTHEMEBACKGROUND)(
        HTHEME, HDC, int, int, const RECT *, OPTIONAL const RECT *);
...
#define Color16to32(c16) (((c16)&0x7C00) >> 7) | (((c16)&0x3E0) << 6) | (((c16)&0x1F) << 19)
    ...
    void
    DrawColorTitleBar(HTHEME hTheme, HDC hOutDC, bool maximized, LPCSTR str, int len, RECT orig);
    void RedrawTitleBar();
    int Round(float n);
