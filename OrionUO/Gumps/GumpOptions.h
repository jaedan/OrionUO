...
private:
    ...
    static const int ID_GO_P2_AUTOMATICALLY_OPEN_DOORS = 204;
    ...
    static const int ID_GO_P2_OBJECT_FADE_IN_OUT = 243;
    ...
    static const int ID_GO_P7_SHADOW_LEVEL = 709;
    ...
    CGUISlider *m_SliderLightLevel = nullptr;
    CGUISlider *m_SliderShadowLevel = nullptr;
