...
const int g_OptionsPolygonColorOffset = 12;
...
void CGumpOptions::DrawPage3()
{
    ...
    if (g_OptionsConfig.ToolTipsTextColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.ToolTipsTextColor);

    m_ColorTooltipText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
...
void CGumpOptions::DrawPage4()
{
    ...
    if (g_OptionsConfig.ChatColorInputText != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.ChatColorInputText);

    m_ColorInputText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorMenuOption = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorPlayerColorInMemberList = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorChatText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorPlayerNameWithoutSpeakingPrivileges = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorMutedText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorChannelModeratorName = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorChannelModeratorText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorMyName = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorMyText = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorSystemMessage = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorTextOutputBackground = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorTextInputBackground = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorUserListBackground = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorConferenceListBackground = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    m_ColorCommandListBackground = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
...
void CGumpOptions::DrawPage7()
{
    ...
    text->CreateTextureW(0, L"Adjust how long speech remains on screen (in tenths of a second)");
    ...
    if (g_OptionsConfig.SpeechColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.SpeechColor);

    m_ColorSpeech = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.EmoteColor != 0xFFFF)
        color =
            g_ColorManager.GetPolygonColor(g_OptionsPolygonColorOffset, g_OptionsConfig.EmoteColor);
    else
        color = 0xFF7F7F7F;

    m_ColorEmote = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.PartyMessageColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.PartyMessageColor);
    else
        color = 0xFF7F7F7F;

    m_ColorPartyMessage = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
...
void CGumpOptions::DrawPage8()
{
    ...
    if (g_OptionsConfig.InnocentColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.InnocentColor);

    m_ColorInnocent = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.FriendlyColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.FriendlyColor);
    else
        color = 0xFF7F7F7F;

    m_ColorFriendly = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.SomeoneColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.SomeoneColor);
    else
        color = 0xFF7F7F7F;

    m_ColorSomeone = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.CriminalColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.CriminalColor);
    else
        color = 0xFF7F7F7F;

    m_ColorCriminal = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.EnemyColor != 0xFFFF)
        color =
            g_ColorManager.GetPolygonColor(g_OptionsPolygonColorOffset, g_OptionsConfig.EnemyColor);
    else
        color = 0xFF7F7F7F;

    m_ColorEnemy = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    if (g_OptionsConfig.MurdererColor != 0xFFFF)
        color = g_ColorManager.GetPolygonColor(
            g_OptionsPolygonColorOffset, g_OptionsConfig.MurdererColor);
    else
        color = 0xFF7F7F7F;

    m_ColorMurderer = (CGUIColoredPolygon *)Add(new CGUIColoredPolygon(
    ...
    switch (state)
    {
        case SCGS_OPT_TOOLTIP_TEXT:
        {
            ...
            m_ColorTooltipText->UpdateColor(
                color, g_ColorManager.GetPolygonColor(g_OptionsPolygonColorOffset, color));
            break;
        }
